...
Defines how the `Product` model integrates with Typesense for real-time indexing via Laravel Scout, including the collection schema and document serialisation.
